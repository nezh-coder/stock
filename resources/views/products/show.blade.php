                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p class="h4 mb-0 text-success">{{ number_format($product->unit_price, 2) }} DH</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                         <a href="{{ route('products.movement', $product->id) }}" class="btn btn-primary btn-block">
                            <i class="fas fa-exchange-alt mr-2"></i>Mouvement du Produit
                        </a>
