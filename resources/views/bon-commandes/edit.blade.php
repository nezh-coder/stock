...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Modifier le Bon de Commande</div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('bon-commandes.update', $bonCommande) }}" method="POST">
                        @csrf
                        @method('PUT')

                        {{-- Numero Bon Commande --}}
                        <div class="mb-3">
                            <label for="numero_bon_commande" class="form-label">Numéro du Bon de Commande</label>
                            <input
                                type="text"
                                name="numero_bon_commande"
                                id="numero_bon_commande"
                                class="form-control"
                                value="{{ old('numero_bon_commande', $bonCommande->numero_bon_commande) }}"
                                required
                            >
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="client_id" id="client_id" class="form-control" required>
                                ...
                                @foreach(\App\Models\Client::all() as $user)
                                    <option value="{{ $user->id }}" {{ old('client_id', $bonCommande->client_id) == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="date_commande"
                                class="form-control"
                                value="{{ old('date_commande', $bonCommande->date_commande) }}"
                                required
                            >
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <table class="table table-bordered" id="products-table">
                                ...
                                <tbody id="products-body">
                                    @foreach($bonCommande->products as $index => $product)
                                    ...
                                    @endforeach
                                    @if($bonCommande->products->isEmpty())
                                    <tr class="product-row">
                                        <td>
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="total_ht"
                                class="form-control"
                                value="{{ old('total_ht', $bonCommande->total_ht) }}"
                                step="0.01"
                                required
                            >
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                id="total_ttc"
                                class="form-control"
                                value="{{ old('total_ttc', $bonCommande->total_ttc) }}"
                                step="0.01"
                                required
                            >
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-control" required>
                                <option value="en_cours" {{ old('status', $bonCommande->status) == 'en_cours' ? 'selected' : '' }}>En Cours</option>
                                <option value="recu" {{ old('status', $bonCommande->status) == 'recu' ? 'selected' : '' }}>Reçu</option>
                                <option value="annule" {{ old('status', $bonCommande->status) == 'annule' ? 'selected' : '' }}>Annulé</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea
                                ...
                                rows="4"
                                class="form-control"
                            >{{ old('notes', $bonCommande->notes) }}</textarea>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    let productIndex = {{ $bonCommande->products->count() }};
