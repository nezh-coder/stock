...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">Créer un Bon de Commande</div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('bon-commandes.store') }}" method="POST">
                        ...
                        {{-- Numero Bon Commande --}}
                       <div class= mb-3">
         <label for="num" class="form-label">Numéro du Bon de Commande</label>
        <input
            type="text"
            name="numero_bon_commande"
            id="num"
            class="form-control"
            value="{{ old('numero_bon_commande') }}"
            required
        >
    </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">Créer BC</button>
                        </div>
                    </form>
                </div>
            </div>
